...
#$settings['league_name']     = 'Rygas Cup';
...
'title' => 'Rygas Cup XII Regular Season Table', # Table title
'length' => 9, # Number of entries in table
...
'fields' => array('Name' => 'name', 'TV' => 'tv', 'P' => 'played', 'W' => 'won', 'D' => 'draw', 'L' => 'lost', 'TDF' => 'gf', 'TDA' => 'ga', 'CAS' => 'tcasf', 'PTS' => 'pts',),
),
...
$settings['fp_leaders'] = array(
    ...
    array(
        'id'        => 1, #get_alt_col('tours','tour_id',$get_prime,'f_did'), # Node ID
        'box_ID'    => 9,
        // Please note: 'type' may be either one of: 'league', 'division' or 'tournament'
        'type'      => 'division', # This sets the node to be a league. I.e. this will make a leaders box for the league with ID = 1
        'title'     => 'RCXII :  Top 10 Hard Hitters (#=CAS)', # Table title
    ...
    array(
        ...
        // Please note: 'type' may be either one of: 'league', 'division' or 'tournament'
        'type'      => 'division', # This sets the node to be a league. I.e. this will make a leaders box for the league with ID = 1
        'title'     => 'RCXII :  Top 10 Touchdown Scorers (#=TD)', # Table title
        'field'     => 'td', # For the OBBLM fields available see http://nicholasmr.dk/obblmwiki/index.php?title=Customization
        'length'    => 10, # Number of entries in table
        'show_team' => true, # Show player's team name?
    ),
    # This will display a 'most comp' player leaders box for the node (league, division or tournament) with ID = 1
    array(
        'id'        => 1, #get_alt_col('tours','tour_id',$get_prime,'f_did'), # Node ID
        'box_ID'    => 10,
        // Please note: 'type' may be either one of: 'league', 'division' or 'tournament'
        'type'      => 'division', # This sets the node to be a tournament. I.e. this will make a leaders box for the tournament with ID = 1
        'title'     => 'RCXII :  Top 10 Passers (#=Comp)', # Table title
        'field'     => 'cp', # For the OBBLM fields available see http://nicholasmr.dk/obblmwiki/index.php?title=Customization
        'length'    => 10, # Number of entries in table
        'show_team' => true, # Show player's team name?
    ),
    # This will display a 'Emerging Stars' player leaders box for the node (league, division or tournament) with ID = 1
    array(
        'id'        => 1, #get_alt_col('tours','tour_id',$get_prime,'f_did'), # Node ID
        'box_ID'    => 7,
        // Please note: 'type' may be either one of: 'league', 'division' or 'tournament'
        'type'      => 'division', # This sets the node to be a tournament. I.e. this will make a leaders box for the tournament with ID = 1
        'title'     => 'RCXII :  Top 10 Emerging Stars (#=SPPs)', # Table title
    ...
    array(
        ...
        'box_ID'    => 15,
        // Please note: 'type' may be either one of: 'league', 'division' or 'tournament'
        'type'      => 'league', # This sets the node to be a league. I.e. this will make a leaders box for the league with ID = 1
        'title'     => 'RC :  All-Time Top 10 Hard Hitters (#=CAS)', # Table title
        'field'     => 'cas', # For the OBBLM fields available see http://nicholasmr.dk/obblmwiki/index.php?title=Customization
        'length'    => 10, # Number of entries in table
        'show_team' => true, # Show player's team name?
    ),
    ...
    array(
        ...
        // Please note: 'type' may be either one of: 'league', 'division' or 'tournament'
        'type'      => 'league', # This sets the node to be a league. I.e. this will make a leaders box for the league with ID = 1
        'title'     => 'RC :  All-Time Top 10 Touchdown Scorers (#=TD)', # Table title
        'field'     => 'td', # For the OBBLM fields available see http://nicholasmr.dk/obblmwiki/index.php?title=Customization
        'length'    => 10, # Number of entries in table
        'show_team' => true, # Show player's team name?
    ),
    ...
    array(
        ...
        'title'     => 'RC :  All-Time Top 10 Passers (#=Comp)', # Table title
        'field'     => 'cp', # For the OBBLM fields available see http://nicholasmr.dk/obblmwiki/index.php?title=Customization
        'length'    => 10, # Number of entries in table
        'show_team' => true, # Show player's team name?
    ),
    ...
    array(
        ...
        // Please note: 'type' may be either one of: 'league', 'division' or 'tournament'
        'type'      => 'league', # This sets the node to be a tournament. I.e. this will make a leaders box for the tournament with ID = 1
        'title'     => 'RC :  All-Time Top 10 Stars (#=SPPs)', # Table title
        'field'     => 'spp', # For the OBBLM fields available see http://nicholasmr.dk/obblmwiki/index.php?title=Customization
        'length'    => 10, # Number of entries in table
        'show_team' => true, # Show player's team name?
    ),
...
$settings['fp_events'] = array(
    ...
    */
    array(
        'id'        => 1, #$get_lid, # Node ID
        'box_ID'    => 11,
        // Please note: 'type' may be either one of: 'league', 'division' or 'tournament'
        'type'      => 'division', # This sets the node to be a league. I.e. this will make an event box for the league with ID = 1
        'title'     => 'Latest Dead Players', # Table title
...
array(
        ...
        // Please note: 'type' may be either one of: 'league', 'division' or 'tournament'
        'type'      => 'division', # This sets the node to be a league. I.e. this will make an event box for the league with ID = 1
        'title'     => 'Latest Skills', # Table title
...
$settings['fp_latestgames'] = array(
    ...
    array(
        ...
        'box_ID' => 2,
        // Please note: 'type' may be either one of: 'league', 'division' or 'tournament'
        'type'   => 'division', # This sets the node to be a league. I.e. this will make a latest games box for the league with ID = 1
        'title'  => 'Latest Rygas Cup Games', # Table title
